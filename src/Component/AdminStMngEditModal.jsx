...
export default function AdminStMngEditModal({ showEdit, handleCloseEdit, selectedEditData, handleUpdateEditData,subjectList }){
  ...
  const handleEditChange = (field, value) => {
    const updatedData = { ...formEditData, [field]: value };

    if (field === "room" && roomData[value]) {
      updatedData.seats = roomData[value]; // auto-set seats
    }

    // ✅ Set the updated data correctly
    setFormEditData(updatedData);
  };
          ...
          <Row className="mb-3">
            ...
            <Col md={6}>
              ...
              >
                ...
                {Object.entries(roomData).map(([room, seats]) => (
