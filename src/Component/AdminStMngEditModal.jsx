...
export default function AdminStMngEditModal({ showEdit, handleCloseEdit, selectedEditData, handleUpdateEditData }){
  ...
  const subjectEditOptions = ["Math", "Biology", "Break", "GK", "Science", "Physics", "Holiday"];
  useEffect(() => {
