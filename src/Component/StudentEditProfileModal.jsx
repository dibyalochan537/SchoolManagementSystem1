        ...
        <Card className="mb-3">
          ...
          <Card.Body>
            ...
            <Row className="mt-2">
              ...
              <Col md={4}><Form.Label>Blood Group</Form.Label>
                <Form.Select name="bloodGroup" value={student.bloodGroup} onChange={handleChange}>
                  <option value={student.bloodGroup}>Current : {student.bloodGroup}</option>
                  <option>A+</option>
                  <option>B+</option>
                  <option>O+</option>
                  <option>AB+</option>
        ...
        <Card className="mb-3">
          ...
          <Card.Body>
            ...
            <Row className="mt-2">
              ...
              <Col md={6}><Form.Label>Previous Class</Form.Label><Form.Control disabled name="previousClass" value={student.previousClass} onChange={handleChange} /></Col>
            </Row>
          </Card.Body>
        </Card>
        ...
        <Card className="mb-3">
          ...
          <Card.Body>
            <Row>
              ...
              <Col md={4}><Form.Label>Scholarship Amount</Form.Label><Form.Control type="number" name="scholarshipAmount" disabled={student.feeType==="Regular"} value={student.scholarshipAmount} onChange={handleChange} /></Col>
        ...
        <Card className="mb-3">
          ...
          <Card.Body>
            <Row>
              ...
              <Col md={4}><Form.Label>ID Proof</Form.Label><Form.Control name="fatherId" placeholder={student.fatherIdProof} onChange={handleChange} /></Col>
            </Row>
            <Row className="mt-2">
              <Col md={6}><Form.Label>Email</Form.Label><Form.Control type="email" name="fatherEmail" placeholder={student.fatherEmailId} onChange={handleChange} /></Col>
              <Col md={6}><Form.Label>Phone</Form.Label><Form.Control type="number" name="fatherPhone" placeholder={student.fatherNumber} onChange={handleChange} /></Col>
            </Row>
        ...
        <Card className="mb-3">
          ...
          <Card.Body>
            <Row>
              ...
              <Col md={4}><Form.Label>ID Proof</Form.Label><Form.Control name="motherId" placeholder={student.fatherIdProof} onChange={handleChange} /></Col>
            </Row>
            <Row className="mt-2">
              <Col md={6}><Form.Label>Email</Form.Label><Form.Control type="email" name="motherEmail" placeholder={student.motherEmailId} onChange={handleChange} /></Col>
              <Col md={6}><Form.Label>Phone</Form.Label><Form.Control type="number" name="motherPhone" placeholder={student.motherNumber} onChange={handleChange} /></Col>
            </Row>
          </Card.Body>
        </Card>
        <Card className="mb-3">
          ...
          <Card.Body>
            <Row>
              ...
              <Col md={4}><Form.Label>ID Proof</Form.Label><Form.Control name="guardianId" placeholder={student.guardianIdProof} onChange={handleChange} /></Col>
            </Row>
            <Row className="mt-2">
              <Col md={6}><Form.Label>Email</Form.Label><Form.Control type="email" name="guardianEmail" placeholder={student.guardianEmailId} onChange={handleChange} /></Col>
              <Col md={6}><Form.Label>Phone</Form.Label><Form.Control type="number" name="guardianPhone" placeholder={student.guardianNumber} onChange={handleChange} /></Col>
              <Col md={6}><Form.Label>WhatsApp Number</Form.Label><Form.Control type="number" name="whatsappNumber" value={student.whatsappNumber} onChange={handleChange} /></Col>
            </Row>
            <Row className="mt-2">
              ...
              <Col md={4}><Form.Label>PIN Code</Form.Label><Form.Control type="number" name="pinCode" value={student.pinCode} onChange={handleChange} /></Col>
            </Row>
          </Card.Body>
        </Card>
      </Modal.Body>
