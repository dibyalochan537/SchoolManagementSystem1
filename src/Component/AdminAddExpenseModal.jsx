...
import {postExpensesData} from "../API/incomeTransaction"
export default function AdminAddExpenseModal({ show, onClose, onSave }) {
  ...
  const handleSubmit = async() => {
    const expenseData = {
      expenseId: Date.now(), // or generate any unique id
      year: formData.accountingYear,
      voucher: formData.voucher,
      amount: formData.amount, 
      particular: formData.particulars,
      typeOfExpense: formData.expenseType,
      paymentMode: formData.paymentMode,
      paidBy: formData.paidBy,
      paidTo: formData.paidTo,
      date: formData.date
    };
    const expenseSendData = {
      serialNo: Date.now(), // unique serial number
      academicYear: formData.accountingYear,
      voucherNo: formData.voucher,
    ...
    await postExpensesData(expenseSendData);
    onSave(expenseData);
    onClose();
  };
