...
const initialData = [
  {
    ...
    seats: 1,
    timetable: [
      ["Monday", "Biology", "Break", "Math", "GK", "Science", "Physics"],
      ["Tuesday", "Break", "Math", "GK", "Biology", "Science", "Physics"],
      ["Wednesday", "Math", "GK", "Break", "Science", "Physics", "Biology"],
      ["Thursday", "GK", "Science", "Physics", "Biology", "Break", "Math"],
      ["Friday", "Science", "Physics", "Biology", "Break", "Math", "GK"],
      ["Saturday", "Physics", "Biology", "Break", "Math", "GK", "Science"],
      ["Sunday", "Holiday", "Holiday", "Holiday", "Holiday", "Holiday", "Holiday"],
    ],
  },
  {
    id: 2,
  ...
  return (
    <>
      ...
      <AdminCreateClassModal 
        ...
        classOptions={["I", "II", "III", "IV", "V"]}
        sectionOptions={["A", "B", "C"]}
        teacherOptions={["Teacher1", "Teacher2", "Teacher3"]}
        subjectOptions={["Math", "Biology", "Break", "GK", "Science", "Physics", "Holiday"]}
      />
    </>
  );
}
