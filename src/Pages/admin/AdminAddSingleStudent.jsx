      ...
      <Card className="mb-4">
        ...
        <Card.Body>
          <Row className="g-3">
            ...
            <Col md={4}><Form.Control type="email" placeholder="Father's Email" value={formData.fatherEmailId} onChange={handleChange("fatherEmailId")} /></Col>
            <Col md={4}>
              <PhoneInput
                country={'in'} // default country
                value={formData.fatherNumber}
                onChange={(phone) =>
                  setFormData({ ...formData, fatherNumber: `+${phone}` })
                }
            ...
            <Col md={4}><Form.Control type="email" placeholder="Mother's Email" value={formData.motherEmailId} onChange={handleChange("motherEmailId")} /></Col>
            <Col md={4}>
              <PhoneInput
                country={'in'} // default to India
                value={formData.motherNumber}
                onChange={(phone) =>
                  setFormData({ ...formData, motherNumber: `+${phone}` })
                }
                inputClass="form-control"
                inputStyle={{ width: '100%' }}
                enableSearch={true}
            ...
            <Col md={4}><Form.Control type="email" placeholder="Guardian's Email" value={formData.guardianEmailId} onChange={handleChange("guardianEmailId")} /></Col>
            <Col md={4}>
              <PhoneInput
                country={'in'} // default country (India)
                value={formData.guardianNumber}
                onChange={(phone) =>
                  setFormData({ ...formData, guardianNumber: `+${phone}` })
                }
                inputClass="form-control"
                inputStyle={{ width: '100%' }}
                enableSearch={true}
            ...
            <Col md={4}><Form.Control type="email" placeholder="District" value={formData.email} onChange={handleChange("email")} /></Col>
            <Col md={2}><Form.Control type="number" placeholder="PIN Code *" value={formData.pinCode} onChange={handleChange("pinCode")} /></Col>
            <Col md={2}>
              <PhoneInput
                country={'in'}
